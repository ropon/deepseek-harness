 ...
 * Browser HTTP shape. The Electron MVP reuses it only on loopback; an
 * IPC-integrated desktop carrier bypasses it. This package never prints: the
 * URL line belongs to the shell.
 */
