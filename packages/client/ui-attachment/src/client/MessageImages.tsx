...
import type { ToolDetailsImagesProps } from '@deepseek-ai/dsh-client-ui-tool/client'
import { ImageGallery } from '../MessageImage.tsx'
import { messageImageLabels } from './labels.ts'

/** Historical message-image slot entry. */
export function MessageImages({ images, loadImage, align, t }: MessageImagesProps | ToolDetailsImagesProps) {
