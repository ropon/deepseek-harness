...
describe('chat row diff body', () => {
  const ownerProps = (block: RunningToolCall | ToolResultNode): GenericToolCardProps => ({
    callId: 'c1', toolName: 'edit', block, openFile: vi.fn(), renderMessageImages: vi.fn(() => null), t,
  })
  ...
  it('a non-diff call keeps the args-JSON text body', () => {
    ...
    const view = render(<GenericToolCard {...{
      callId: 'c1', toolName: 'some_tool', openFile: vi.fn(), renderMessageImages: vi.fn(() => null), t,
      block: settled({
